...
// Source: github.com/romshark/sched/sched (interfaces: TimeProvider,Timer)
...
import (
	...
	sched "github.com/romshark/sched/sched"
)
...
func (m *MockTimeProvider) AfterFunc(arg0 time.Duration, arg1 func()) sched.Timer {
	m.ctrl.T.Helper()
...
func (mr *MockTimeProviderMockRecorder) AfterFunc(arg0, arg1 interface{}) *gomock.Call {
